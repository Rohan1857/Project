...
router.post("/run", authMiddleware, async (req, res) => {
    ...
    try {
        const response = await axios.post('https://congenial-eureka-g4q64q75wwjr2r64-8000.app.github.dev/run', {
            language,
            code,
            input
        });
...
router.post("/submit", authMiddleware, async (req, res) => {
    ...
    try {
        ...
        const response = await axios.post('https://congenial-eureka-g4q64q75wwjr2r64-8000.app.github.dev/submit', {
            language,
            code,
            inputs
        });
